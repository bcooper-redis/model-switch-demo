...
2. Expand sections to inspect the original source passages and line numbers. Professional sections and AI working preferences are selected initially; other sections are unchecked. Select/exclude sections or individual passages, edit the memory wording, and choose categories.
